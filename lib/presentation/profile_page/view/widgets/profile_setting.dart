...
import 'package:elevate_super_fitness/presentation/profile_page/view/widgets/custom_profile_dialog.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              CustomProfileDialog.showSecurityDialog(context);
            },
            child: CustomProfileRow(
          ...
          InkWell(
            onTap: () {
              CustomProfileDialog.showPrivacyDialog(context);
            },
            child: CustomProfileRow(
          ...
          InkWell(
            onTap: () {
              CustomProfileDialog.showHelpDialog(context);
            },
            child: CustomProfileRow(
              icon: AppIcons.help,
        ...
        InkWell( onTap: () {
          ...
          child: Row(
            children: [
              Image.asset(  AppIcons.logout,color: AppColors.mainColorL, width: 24.sp, height: 24.sp),
              SizedBox(width: 16.w,),
